...
$routes->get('/', 'PemilihanController::index', ['namespace' => 'App\Controllers\Pemilih', 'filter' => 'pemilihfilter']);
$routes->get('/login', 'AuthController::index', ['filter' => 'loginfilter']);
$routes->post('/postlogin', 'AuthController::postlogin');
$routes->post('/logout', 'AuthController::logout');

// Pemilih routes 

$routes->group('paslon', ['namespace' => 'App\Controllers\Pemilih', 'filter' => 'pemilihfilter'], function ($routes) {
...
$routes->group('admin', ['namespace' => 'App\Controllers\Admin', 'filter' => 'adminfilter'], function ($routes) {
    ...
    $routes->group('paslon', function ($routes) {
        ...
        $routes->post('add', 'DataPaslonController::add');
        $routes->get('detail/(:any)', 'DataPaslonController::detail/$1');
        $routes->post('update(:any)', 'DataPaslonController::update/$1');
