    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row" action="/admin/paslon/add" method="POST" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
        ...
        <tbody>
            <?php foreach ($paslon as $pas) : ?>
                <tr>
                    ...
                    <td>
                        <a href="/admin/paslon/edit/<?= $pas['id_paslon']; ?>">
                            <i class='bx bxs-edit text-purple fs-4'></i>
                        </a>
                        <a href="/admin/paslon/delete/<?= $pas['id_paslon']; ?>">
                            <i class='bx bxs-trash-alt text-danger fs-4'></i>
                        </a>
                    </td>
                    <td>
                        <a href="/admin/paslon/detail/<?= $pas['id_paslon']; ?>" class="btn btn-purple"> Detail </a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
